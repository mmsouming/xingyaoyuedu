...
public class SplashActivity extends BaseFragmentActivity implements View.OnClickListener, LoginManager.LoginListener {
    ...
    private void toNextPage() {
        List<StudentVo> studentVo = UserInfoManager.getInstance().getStudentVos() ;
        if(studentVo == null || studentVo.size() == 0 ){
            startActivity(new Intent(this,ActivateTipActivity.class));
        } else {
