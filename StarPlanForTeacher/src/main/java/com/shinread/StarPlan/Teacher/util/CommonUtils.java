...
public class CommonUtils {
     ...
     * @return
     */
    public static StudentVo getDefaultStudentVo() {
//        List<StudentVo> studentVos = AppService.mKinds ;
//        if(null == studentVos || studentVos.size() == 0) {
//            return null ;
//        }
//        int size = studentVos.size();
//        for(int i = 0 ; i < size ; i++) {
//            if(studentVos.get(i).isDefaultMark()) {
//                return studentVos.get(i) ;
//            }
//        }
        return null ;
    }
...
//    }
    ...
    public static void loadImage(ImageView view, String url) {
        ...
        Glide.with(FFApplication.instance).load(toBrowserCode(url))
                .into(view);
        // ImageLoader.getInstance().displayImage(url, view);
        // FFApp.getInstance().getImageLoader().DisplayImage(url, view);
    }
