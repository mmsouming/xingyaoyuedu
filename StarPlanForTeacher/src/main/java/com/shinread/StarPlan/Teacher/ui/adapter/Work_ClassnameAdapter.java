...
/**
 * Created by lizehong on 2016/5/5.选择班级名字的适配器、
 */
public class Work_ClassnameAdapter extends BaseAdapter{

    private Activity context;
    List<ClassesListVo> list;
    private int resourceId; // 适配器视图资源ID

    public Work_ClassnameAdapter(Activity context, List<ClassesListVo> list, int resourceId, OnAdapterHandleListeners onAdapterHandleListeners) {
    ...
    public static interface OnAdapterHandleListeners {
        void select(List<ClassesListVo> list, boolean flag);
    }
